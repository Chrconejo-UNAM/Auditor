...
st.title("🔍 Auditor de Sesgos de Género en la Investigación")
...
<div style="text-align: center; padding: 20px; color: #FFFFFF;">
    <p style="font-size: 16px; margin-bottom: 5px;"><strong>Desarrollado por:</strong></p>
    <p style="font-size: 15px; color: #E6C875; font-weight: bold;">
        Christian Alexis Ramírez Conejo<br>
        Derek Ulises Tapia Jauregui<br>
        Milton Velasquez Peña
    </p>
